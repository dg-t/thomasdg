    ...
    <div class="row container-fluid projects">
        ...
        <div class="col-lg-7 flip-box" v-if="id=='restaurant-reviews'">
          <div class="flip-box-inner">
            <p class="ghost_text" v-if="show">{{title}}</p>
            <img :src="image" class="flip-box-front img-fluid image_box" :alt="title" @mouseover="show = !show">
            <img :src="image_two" class="flip-box-back img-fluid image_box" :alt="title" @mouseleave="show = !show">
          </div>
        </div>
